...
import HK from "./completion-database.js";
...
function HKCheckCompletion(jsonObject, benchStart = performance.now()) {
  ...
  /* Extended completion is calculated after all individual checks. */
  ...
  window.dispatchEvent(new CustomEvent("hallownest-save-analyzed", {
    detail: {
      database: HK,
      save: jsonObject
    }
