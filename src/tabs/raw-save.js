import { escapeHTML } from "../app/tracker-model.js";
...
function renderRawSave() {
  ...
  document.querySelector("#raw-view").innerHTML = `
    <div class="view-heading compact"><div><span class="overline">Decoded locally</span><h1>Raw Save Data</h1><p>Inspect, copy, or download the exact JSON produced by the decoder.</p></div></div>
